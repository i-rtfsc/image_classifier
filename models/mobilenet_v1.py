...
class MobileNetV1(BaseModel):
    def __init__(self, num_classes=1000, input_shape=(224, 224, 13), input_tensor_name='input',
        ...
        self.separable_conv_7 = self.SeparableConv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same")
        self.separable_conv_8 = self.SeparableConv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same")
        self.separable_conv_9 = self.SeparableConv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same")
        self.separable_conv_10 = self.SeparableConv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same")
        self.separable_conv_11 = self.SeparableConv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same")
        self.separable_conv_12 = self.SeparableConv2D(filters=1024, kernel_size=(3, 3), strides=2, padding="same")
        self.separable_conv_13 = self.SeparableConv2D(filters=1024, kernel_size=(3, 3), strides=1, padding="same")
