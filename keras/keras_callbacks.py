...
class Callback:
    ...
    Attributes:
        ...
        model: Instance of `keras.net.Model`.
...
class History(Callback):
    ...
    gets returned by the `fit` method of net.
    Example:
    >>> model = tf.keras.net.Sequential([tf.keras.layers.Dense(10)])
...
class ModelCheckpoint(Callback):
    ...
    Args:
        ...
        monitor: The metric name to monitor. Typically the metrics are set by the
          ...
          * If you're not sure about the metric names you can check the contents
            ...
            `history = model.fit()`
          * Multi-output net set additional prefixes on the metric names.
    ...
    def __init__(self,
        ...
        self.model_filepath = path_to_string(model_filepath)
                    ...
                    if current is None:
                        ...
                        if self.monitor_op(current, self.best):
                            ...
                            if self.save_weights_only:
                                ...
                                # save the model
                                # tf.keras.net.save_model(self.model, model_filepath)
    ...
    def _configure_embeddings(self):
        ...
        for layer in self.model.layers:
            if isinstance(layer, embeddings.Embedding):
                ...
                # consistent in any keras net checkpoints.
