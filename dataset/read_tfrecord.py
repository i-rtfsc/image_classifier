...
class ReadTfrecord(BaseTfrecord):
    ...
    def get_keras_datasets(self):
        train_dataset = lambda: self.get_dataset_from_tfrecord_by_keras(self.train_tfrecord_list)
        valid_dataset = lambda: self.get_dataset_from_tfrecord_by_keras(self.val_tfrecord_list)
        test_dataset = lambda: self.get_dataset_from_tfrecord_by_keras(self.test_tfrecord_list)
        return train_dataset, valid_dataset, test_dataset